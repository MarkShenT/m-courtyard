...
<div align="center">
  <img src="docs/screenshots/0228/Dashboard.png" alt="M-Courtyard 仪表盘" width="800">
</div>
...
<details>
<summary><b>步骤 1: 数据准备</b> (点击展开)</summary>
<br>
导入文档，自动清洗，并使用本地大模型生成训练数据集。
<div align="center">
  <img src="docs/screenshots/0228/Data Preparation_1.png" alt="数据准备 1" width="800">
  <br><br>
  <img src="docs/screenshots/0228/Data Preparation_2.gif" alt="数据准备 2" width="800">
</div>
</details>

<details>
<summary><b>步骤 2: 模型训练</b> (点击展开)</summary>
<br>
基于 Apple MLX 驱动，实时呈现 Loss 曲线、预计完成时间和训练进度。
<div align="center">
  <img src="docs/screenshots/0228/Training Progress_1.gif" alt="训练进度 1" width="800">
  <br><br>
  <img src="docs/screenshots/0228/Training Progress_2.gif" alt="训练进度 2" width="800">
  <br><br>
  <img src="docs/screenshots/0228/Training Progress_3.png" alt="训练总结" width="800">
</div>
</details>

<details>
<summary><b>步骤 3: 测试模型</b> (点击展开)</summary>
<br>
通过内置聊天界面即时验证微调后的适配器质量。
<div align="center">
  <img src="docs/screenshots/0228/Test Model.png" alt="测试模型" width="800">
</div>
</details>

<details>
<summary><b>步骤 4: 导出至 Ollama</b> (点击展开)</summary>
<br>
一键合并权重、量化 (Q4/Q8/F16)，并直接导出至 Ollama。
<div align="center">
  <img src="docs/screenshots/0228/Export to Ollama_1.png" alt="导出至 Ollama 1" width="800">
  <br><br>
  <img src="docs/screenshots/0228/Export to Ollama_2.gif" alt="导出至 Ollama 2" width="800">
</div>
</details>
